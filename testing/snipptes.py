...
print a.userGetOrCreate(username='posdfsssddfafs',email='palnnisdfdsaafdssdnfdsdsfsso@google.com').text
#id = a.getValue(a.createReward(type='CCM',quantity=12.1),'id')
#print id
